            ...
            <div class="bg-white p-6 rounded-lg shadow-sm">
                ...
                <form action="<?php echo e(route('items.store')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="item_name" value="<?php echo e(old('item_name')); ?>" class="w-full border-gray-300 rounded-md shadow-sm" required placeholder="e.g. Blue Wallet">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="type" class="w-full border-gray-300 rounded-md shadow-sm">
                            <option value="lost" <?php echo e(old('type') == 'lost' ? 'selected' : ''); ?>>I Lost This</option>
                            <option value="found" <?php echo e(old('type') == 'found' ? 'selected' : ''); ?>>I Found This</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" rows="3" class="w-full border-gray-300 rounded-md shadow-sm" placeholder="Describe the item (color, brand, etc.)"><?php echo e(old('description')); ?></textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="location" value="<?php echo e(old('location')); ?>" class="w-full border-gray-300 rounded-md shadow-sm" placeholder="e.g. School Library">
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/riku/Documents/laravel_poject/lost_n_found/resources/views/items/create.blade.php ENDPATH**/ ?>