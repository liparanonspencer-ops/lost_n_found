        ...
        <div class="relative px-6 pb-8">
            <div class="relative -mt-12 sm:-mt-16 flex flex-col sm:flex-row items-center sm:items-end space-y-4 sm:space-y-0 sm:space-x-5 text-center sm:text-left">
                ...
                <div class="relative">
                    <img class="h-24 w-24 sm:h-32 sm:w-32 rounded-full border-4 border-white object-cover shadow-md" 
                         src="<?php echo e($user->photo_url ?? 'https://ui-avatars.com/api/?name='.urlencode($user->first_name)); ?>" 
                         alt="Profile Photo">
                ...
                <div class="pb-2">
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-900"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></h1>
                    <p class="text-xs sm:text-sm font-medium text-gray-500 italic">Acc ID: #<?php echo e($user->id); ?></p>
                </div>
            </div>
            ...
            <div class="mt-8 grid grid-cols-1 gap-4 sm:gap-6 border-t border-gray-100 pt-8 sm:grid-cols-3">
                ...
                <div class="flex flex-col space-y-1 p-3 bg-gray-50 sm:bg-transparent rounded-lg sm:p-0">
                    ...
                    <span class="text-sm text-gray-700 font-medium break-all"><?php echo e($user->email); ?></span>
                </div>
                ...
                <div class="flex flex-col space-y-1 p-3 bg-gray-50 sm:bg-transparent rounded-lg sm:p-0">
                    ...
                    <span class="text-sm text-gray-700 font-medium"><?php echo e($user->created_at->format('M Y')); ?></span>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/riku/Documents/laravel_poject/lost_n_found/resources/views/profile/show.blade.php ENDPATH**/ ?>