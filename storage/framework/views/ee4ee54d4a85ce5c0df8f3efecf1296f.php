<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="<?php echo e(Auth::user()->theme_preference === 'dark' ? 'dark' : ''); ?>">
    ...
    <head>
        ...
        <title><?php echo e(config('app.name', 'STI lost&found')); ?></title>
...
</html><?php /**PATH /home/riku/Documents/laravel_poject/lost_n_found/resources/views/layouts/app.blade.php ENDPATH**/ ?>