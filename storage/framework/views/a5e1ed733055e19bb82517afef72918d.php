    ...
    <div class="py-10 bg-slate-50 dark:bg-gray-900 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-slate-200 dark:bg-gray-800 rounded-[2rem] shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-gray-700 overflow-hidden">
                                ...
                                <tr class="hover:bg-slate-50/50 dark:hover:bg-gray-700/30 transition-colors group">
                                        ...
                                        <div class="flex items-center">
                                            <div class="w-10 h-10 rounded-lg bg-slate-100 dark:bg-gray-700 flex items-center justify-center shrink-0">
                                                <?php if($claim->item->image_path): ?>
                                                    <img src="<?php echo e(asset('storage/' . $claim->item->image_path)); ?>" class="w-full h-full rounded-lg object-cover">
                                                <?php else: ?>
                                            ...
                                            <div class="ml-4">
                                                <div class="font-bold text-slate-800 dark:text-slate-200 leading-tight"><?php echo e($claim->item->item_name); ?></div>
                                                <div class="text-[11px] font-medium text-indigo-500 uppercase tracking-tighter mt-0.5"><?php echo e($claim->item->category); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="p-6">
                                        <div class="text-sm font-bold text-slate-700 dark:text-slate-300"><?php echo e($claim->user->first_name); ?> <?php echo e($claim->user->last_name); ?></div>
                                    ...
                                    <td class="p-6">
                                        <div class="flex flex-col">
                                            <span class="text-sm font-bold text-slate-600 dark:text-slate-400"><?php echo e($claim->updated_at->format('M d, Y')); ?></span>
                                            <span class="text-[10px] font-medium text-slate-400"><?php echo e($claim->updated_at->format('h:i A')); ?></span>
                                        </div>
                                    </td>
                                    <td class="p-6 text-right">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm
                                            <?php echo e($claim->status === 'approved' 
                                            ...
                                            <span class="w-1.5 h-1.5 rounded-full mr-2 <?php echo e($claim->status === 'approved' ? 'bg-emerald-500' : 'bg-rose-500'); ?>"></span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/riku/Documents/laravel_poject/lost_n_found/resources/views/admin/claims/history.blade.php ENDPATH**/ ?>