...
<head>
    ...
    <title><?php echo e(config('app.name', 'Lost & Found')); ?></title>
...
<body
            ...
            <div
                ...
                <div class="mb-8">
                    ...
                    <p class="text-[#706f6c] dark:text-[#A1A09A] leading-relaxed">
                        Welcome to the official STI Lost and Found system. Reconnecting you with your belongings through
                        a simple, organized community hub.
                    </p>
                </div>

                <div class="grid gap-4 mt-6">
                    <a href="<?php echo e(route('register')); ?>"
                        class="group flex items-start gap-4 p-4 rounded-lg border border-[#e3e3e0] dark:border-[#3E3E3A] hover:bg-[#FDFDFC] dark:hover:bg-[#1b1b18] transition-all">
                        <div
                            class="shrink-0 w-10 h-10 bg-[#fff2f2] dark:bg-[#2d1010] rounded-full flex items-center justify-center text-[#f53003]">
                        ...
                        <div>
                            ...
                            <p class="text-[13px] text-[#706f6c] dark:text-[#A1A09A]">Fill out a form to let others know
                                what you've lost.</p>
                        </div>
                    </a>
                    ...
                    <a href="#"
                        class="group flex items-start gap-4 p-4 rounded-lg border border-[#e3e3e0] dark:border-[#3E3E3A] hover:bg-[#FDFDFC] dark:hover:bg-[#1b1b18] transition-all">
                        <div
                            class="shrink-0 w-10 h-10 bg-blue-50 dark:bg-blue-900/20 rounded-full flex items-center justify-center text-blue-600">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div>
                            ...
                            <p class="text-[13px] text-[#706f6c] dark:text-[#A1A09A]">Search through the gallery of
                                items already surrendered.</p>
                        </div>
                    </a>
                </div>
            </div>
    ...
    style="background-image: url('<?php echo e(asset('image/lst_n_fnd.png')); ?>');">
    ...
    <footer class="mt-8 text-[12px] text-[#706f6c] dark:text-[#A1A09A]">
        &copy; <?php echo e(date('Y')); ?> Lost & Found System &middot; STI 
    </footer>
</body>

</html><?php /**PATH /home/riku/Documents/laravel_poject/lost_n_found/resources/views/welcome.blade.php ENDPATH**/ ?>